...
CREATE TABLE Prueba4 (
  id INT AUTO_INCREMENT PRIMARY KEY,
  userId INT NOT NULL,
  preciso BOOLEAN NOT NULL,
  preferencia BOOLEAN NOT NULL,
  entiendeConsulta BOOLEAN NOT NULL,
  innovador BOOLEAN NOT NULL,
  lenguajeNatural BOOLEAN NOT NULL,
  facilidad BOOLEAN NOT NULL,
  moderno BOOLEAN NOT NULL,
  pocoTiempo BOOLEAN NOT NULL,
